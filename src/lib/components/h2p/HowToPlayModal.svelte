...
<Dialog.Root>
    ...
    <Dialog.Content class="min-w-fit max-w-fit">
        <Dialog.Header>
        ...
        <div class="flex flex-col">
            ...
            <p class="text-md">
                Gnomes are tracked for as long as you are in a voice channel. Once everyone in the
                voice channel disconnects, the game will end!
            </p>
        </div>
    </Dialog.Content>
</Dialog.Root>
